...
const itemsRows = document.querySelector("div[class='item-rows']");
for (const property in _currencyRates.default) {
...
updateCurrency(currencyPicker, _view.renderTotals);
},{"./cart.json":"js/cart.json","./currencyRates.json":"js/currencyRates.json","./Row":"js/Row.js","./view":"js/view.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
